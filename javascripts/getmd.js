		...
		xmlhttp.onreadystatechange = function (){
			if (xmlhttp.readyState==4){// 4 = "loaded"
				...
				if (xmlhttp.status==200){// 200 = "OK"
					...
					var converter = new Showdown.converter();
					content.innerHTML = '<div id="content_inner"><div id="back_home"><a href="/" onclick="home();return false;">'+sitetitle+'</a><span>&nbsp;›&nbsp;</span><hr class="ws-space-16"></div><br><center><div id="post_title"><h1>' + decodeUtf8(getPostName(path)) + (encoded?Base64.decode('PHN1cCBzdHlsZT0iZm9udC1zaXplOjAuNWVtO3ZlcnRpY2FsLWFsaWduOiBzdXBlcjsiIHRpdGxlPSLmraTmlofnq6Dlt7Looqvph43mlrDnvJbnoIHku6XourLpgb/lrqHmn6UiPuKYmuiiq+e8lueggeeahOWGheWuuTwvc3VwPg=='):'') + '</h1></div></center><hr class="ws-space-16">' + converter.makeHtml(blog_text) + '<br><div class="date"><hr class="ws-space-16">发布于 ' + pdate + '</div></div>';
					if(dis){
